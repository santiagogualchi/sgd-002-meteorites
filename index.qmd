...
Reports of falling rocks and discoveries on land extend thousands of years into
the past, but the mysteries of their origin and nature were not always
...
`r pretty_number(n_meteorites_in_milestone, Inf, big.mark = ",")` meteorites
...
`r pretty_number(current_record, Inf, big.mark = ",")` meteorites discovered. As
